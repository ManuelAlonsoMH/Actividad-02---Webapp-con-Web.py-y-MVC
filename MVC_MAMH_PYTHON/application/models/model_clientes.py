...
def insert_clientes(nombre,telefono,sexo,correo):
    try:
        return db.insert('clientes', 
        nombre=nombre,
        telefono=telefono,
        sexo=sexo,
        correo=correo) # inserta un registro en producto
    except Exception as e:
...
def update_clientes(nombre,telefono,sexo,correo): # actualiza los datos de la tabla clientes que coincidan con el nombre
    try:
