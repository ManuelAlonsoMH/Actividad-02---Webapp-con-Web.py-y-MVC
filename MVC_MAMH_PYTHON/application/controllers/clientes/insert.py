...
class Insert:
    ...
    def POST(self):
        ...
        telefono = formulario['telefono'] # almacena el contenido escrito en el input
        sexo = formulario['sexo'] # alamcena la marca escrito en el input
        correo = formulario['correo'] # alamcena el precio escrito en el input
